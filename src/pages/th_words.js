...
function ThWords() {
  ...
  const submitScore = (e) => {
    ...
    axios
      .post(API_BASE_URL + "/thwords/score", data)
                  ...
                  <div className="project-box-wrapper" key={question._id}>
                    ...
                    >
                      ...
                      {/* <Button
                        ...
                        onClick={() => speak(question.options[question.answer])}
                      >
                        Listen
                      </Button> */}
                      <Button
